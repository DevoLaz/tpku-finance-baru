                    ...
                    <tbody>
                        @forelse ($pengadaansByInvoice as $invoiceNumber => $items)
                            <tbody x-data="{ open: false }">
                                {{-- Baris utama, TIDAK LAGI memiliki @click --}}
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    {{-- PERUBAHAN KUNCI: @click sekarang ada di sini, di kolom "Detail" --}}
                                ...
                                {{-- Baris detail, tidak ada perubahan di sini --}}
                                        ...
                                        <div class="p-4">
                                            <div class="flex justify-end items-center gap-3 mb-4">
                                                ...
                                                <button 
                                                    ...
                                                    data-img-url="{{ asset($items->first()->bukti) }}">
