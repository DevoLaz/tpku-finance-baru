<x-app-layout>
    ...
    <div class="p-8" x-data="pengadaanForm()" x-init="init()">
        ...
        {{-- Form Utama --}}
        <form id="pengadaanForm" action="{{ route('pengadaan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            {{-- PERBAIKAN: Input ini akan dibuat oleh JS jika tombol "Gunakan" ditekan --}}
            {{-- Tidak perlu ada input manual di sini --}}
            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div>
                        ...
                        <input type="text" id="no_invoice" name="no_invoice" value="{{ old('no_invoice') }}"
                    ...
                    <div>
                        ...
                        {{-- PENINGKATAN: x-model ditambahkan untuk integrasi dengan AlpineJS --}}
                    ...
                    <template x-for="(item, index) in items" :key="index">
                        <div class="grid grid-cols-12 gap-4 items-center p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="col-span-5">
                                ...
                                {{-- PENINGKATAN: Select dinonaktifkan jika supplier belum dipilih --}}
                                <select
                ...
                {{-- Tambah Barang & Grand Total --}}
                <div class="flex justify-between items-center mt-6 pt-6 border-t">
                    {{-- PENINGKATAN: Tombol dinonaktifkan jika supplier belum dipilih --}}
