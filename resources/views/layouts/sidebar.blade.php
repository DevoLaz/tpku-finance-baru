<aside class="flex flex-col w-20 hover:w-64 bg-[#173720] text-white shadow-md border-r border-[#2a5132] fixed top-0 left-0 h-screen transition-all duration-300 overflow-hidden z-50 group/sidebar">
    ...
    <div class="flex-1 overflow-y-auto no-scrollbar">
        <nav class="flex flex-col px-4 py-6 space-y-1 text-base">
            ...
            <a href="{{ route('transaksi.index') }}" class="flex items-center gap-3 p-2 rounded-md transition {{ request()->routeIs('transaksi.*') ? 'bg-[#246342] font-semibold' : 'hover:bg-[#246342]' }}">
            ...
            <a href="{{ route('pengadaan.index') }}" class="flex items-center gap-3 p-2 rounded-md transition {{ request()->routeIs('pengadaan.*') ? 'bg-[#246342] font-semibold' : 'hover:bg-[#246342]' }}">
            ...
            <a href="{{ route('beban.index') }}" class="flex items-center gap-3 p-2 rounded-md transition {{ request()->routeIs('beban.*') ? 'bg-[#246342] font-semibold' : 'hover:bg-[#246342]' }}">
            ...
            <a href="{{ route('laporan.penggajian.index') }}" class="flex items-center gap-3 p-2 rounded-md transition {{ request()->routeIs('laporan.penggajian.*') ? 'bg-[#246342] font-semibold' : 'hover:bg-[#246342]' }}">
            ...
            <a href="{{ route('karyawan.index') }}" class="flex items-center gap-3 p-2 rounded-md transition {{ request()->routeIs('karyawan.*') ? 'bg-[#246342] font-semibold' : 'hover:bg-[#246342]' }}">
