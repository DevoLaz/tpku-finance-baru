        ...
        <div class="bg-gradient-to-r from-[#173720] to-[#2a5a37] rounded-lg p-6 mb-6 shadow-lg">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-4">
                    {{-- Tombol Ekspor PDF --}}
                    <a href="{{ route('laporan.arus_kas.exportPdf', request()->query()) }}" class="px-6 py-3 bg-red-500 hover:bg-red-600 text-white rounded-lg font-semibold flex items-center gap-2 transition-transform transform hover:scale-105">
                    ...
                    {{-- Tombol Ekspor Excel --}}
                    <a href="{{route('laporan.arusKas.exportExcel', request()->query())}}" class="px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-lg font-semibold flex items-center gap-2 transition-transform transform hover:scale-105">
