                ...
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                    <div class="flex-1 px-0">
                        ...
                        <div class="flex items-center text-sm text-green-200 text-left space-x-1">
                            ...
                            <span>Terakhir diperbarui: <?php echo e(now('Asia/Jakarta')->format('d M Y, H:i')); ?> WIB</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <p class="text-3xl font-bold text-gray-900 animated-counter stats-glow">
                                Rp <?php echo e(number_format($totalKas, 0, ',', '.')); ?>
                ...
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-900 animated-counter">
                            Rp <?php echo e(number_format($totalAset, 0, ',', '.')); ?>
            ...
            <div class="glass-card metric-card rounded-2xl p-6">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold animated-counter <?php echo e($labaRugiBulanIni >= 0 ? 'text-green-900' : 'text-red-600'); ?>">
                            Rp <?php echo e(number_format($labaRugiBulanIni, 0, ',', '.')); ?>

                        </p>
                    </div>
                    <div class="p-4 rounded-2xl text-white" style="background: linear-gradient(135deg, <?php echo e($labaRugiBulanIni >= 0 ? '#10b981, #059669' : '#ef4444, #dc2626'); ?>);">
                        <i data-lucide="<?php echo e($labaRugiBulanIni >= 0 ? 'trending-up' : 'trending-down'); ?>" class="w-8 h-8"></i>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <div class="flex items-baseline gap-2">
                            <p class="text-3xl font-bold text-orange-900 animated-counter"><?php echo e($totalKaryawan); ?></p>
            ...
            <div class="insight-card rounded-2xl p-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold <?php echo e($marjinLabaBersih >= 0 ? 'text-green-700' : 'text-red-600'); ?>">
                            <?php echo e(number_format($marjinLabaBersih, 1)); ?>%
                        </p>
                    </div>
                    <div class="w-16 h-16 relative flex items-center justify-center">
                        <svg class="progress-ring w-16 h-16">
                            ...
                            <circle cx="32" cy="32" r="28" stroke="<?php echo e($marjinLabaBersih >= 0 ? '#22c55e' : '#ef4444'); ?>" stroke-width="4" fill="transparent"
                                    stroke-dasharray="175.93" stroke-dashoffset="<?php echo e(175.93 - (175.93 * min(abs($marjinLabaBersih), 100)) / 100); ?>" class="progress-ring-circle"/>
                        </svg>
                        <span class="absolute font-bold text-lg <?php echo e($marjinLabaBersih >= 0 ? 'text-green-700' : 'text-red-600'); ?>">
                            <?php echo e(number_format($marjinLabaBersih, 0)); ?>%
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="insight-card rounded-2xl p-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between text-sm">
                        ...
                        <span class="font-semibold text-blue-700"><?php echo e(number_format($efisiensiOperasional, 1)); ?>%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-blue-500 h-2 rounded-full" style="width: <?php echo e(min($efisiensiOperasional, 100)); ?>%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="insight-card rounded-2xl p-6">
                ...
                <div class="space-y-2">
                    <div class="flex items-center gap-2 text-sm">
                        ...
                        <span class="text-gray-600"><?php echo e($aktivitasMasukHariIni); ?> Transaksi masuk</span>
                    </div>
                    <div class="flex items-center gap-2 text-sm">
                        <span class="w-2 h-2 bg-red-500 rounded-full"></span>
                        <span class="text-gray-600"><?php echo e($aktivitasKeluarHariIni); ?> Transaksi keluar</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-8">
            ...
            <div class="xl:col-span-2 chart-container rounded-3xl p-6">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6">
                    <div>
                        ...
                        <?php if($arusKasChart->isNotEmpty()): ?>
                            <p class="text-sm text-gray-500">Periode: <?php echo e($arusKasChart->first()['bulan'] ?? '-'); ?> - <?php echo e($arusKasChart->last()['bulan'] ?? '-'); ?></p>
                        <?php else: ?>
                    ...
                    <div class="flex gap-4 mt-4 sm:mt-0">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm font-medium text-gray-600">
                                Masuk: Rp <?php echo e(number_format(array_sum(array_column($arusKasChart->toArray(), 'masuk')), 0, ',', '.')); ?>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm font-medium text-gray-600">
                                Keluar: Rp <?php echo e(number_format(array_sum(array_column($arusKasChart->toArray(), 'keluar')), 0, ',', '.')); ?>
            ...
            <div class="chart-container rounded-3xl p-6">
                ...
                <div class="space-y-3 mb-6">
                    <?php $__currentLoopData = $pengeluaranChart['labels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-3 rounded-xl" style="background: <?php echo e(['#ef444410', '#f9731610', '#eab30810'][$i % 3]); ?>">
                            <div class="flex items-center gap-3">
                                <div class="w-3 h-3 rounded-full" style="background: <?php echo e(['#ef4444', '#f97316', '#eab308'][$i % 3]); ?>"></div>
                                <span class="text-sm font-medium text-gray-700"><?php echo e($label); ?></span>
                            </div>
                            <span class="text-sm font-bold" style="color: <?php echo e(['#ef4444', '#f97316', '#eab308'][$i % 3]); ?>">
                                Rp <?php echo e(number_format($pengeluaranChart['data'][$i], 0, ',', '.')); ?>
                            ...
                            <td class="p-4">
                                <div class="flex flex-col">
                                    <span class="text-sm font-medium text-gray-900">
                                        <?php echo e(\Carbon\Carbon::parse($transaksi->tanggal)->isoFormat('D MMM YY')); ?>

                                    </span>
                                    <span class="text-xs text-gray-500">
                                        <?php echo e(\Carbon\Carbon::parse($transaksi->created_at)->isoFormat('HH:mm')); ?> WIB
                                    </span>
                                </div>
                            </td>
                            <td class="p-4">
                                <div class="flex items-center gap-3">
                                    <div class="p-2 rounded-lg <?php echo e($transaksi->tipe == 'masuk' ? 'bg-green-100' : 'bg-red-100'); ?>">
                                        <i data-lucide="<?php echo e($transaksi->tipe == 'masuk' ? 'arrow-down-left' : 'arrow-up-right'); ?>" 
                                           class="w-4 h-4 <?php echo e($transaksi->tipe == 'masuk' ? 'text-green-600' : 'text-red-600'); ?>"></i>
                                    </div>
                                    <div>
                                        
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($transaksi->deskripsi); ?></p>
                                        <p class="text-xs text-gray-500">ID: #<?php echo e(substr(md5($transaksi->id), 0, 8)); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="p-4 text-center">
                                <span class="badge <?php echo e($transaksi->tipe == 'masuk' ? 'badge-masuk' : 'badge-keluar'); ?>">
                                    <i data-lucide="<?php echo e($transaksi->tipe == 'masuk' ? 'plus' : 'minus'); ?>" class="w-3 h-3"></i>
                                    <?php echo e(ucfirst($transaksi->tipe)); ?>

                                </span>
                            </td>
                            <td class="p-4 text-right">
                                <span class="text-lg font-bold <?php echo e($transaksi->tipe == 'masuk' ? 'text-green-600' : 'text-red-600'); ?>">
                                    <?php echo e($transaksi->tipe == 'masuk' ? '+' : '-'); ?> Rp <?php echo e(number_format(abs($transaksi->jumlah), 0, ',', '.')); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const arusKasData = <?php echo json_encode($arusKasChart, 15, 512) ?>;
                const pengeluaranData = <?php echo json_encode($pengeluaranChart, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\tpku-finance-baru\resources\views/dashboard.blade.php ENDPATH**/ ?>