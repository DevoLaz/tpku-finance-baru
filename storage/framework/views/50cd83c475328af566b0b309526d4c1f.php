...
<?php $component->withAttributes([]); ?>
    <div class="min-h-screen flex items-center justify-center bg-[#F9FAF9] py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="!mt-8 space-y-6" method="POST" action="<?php echo e(route('password.store')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <input id="email" name="email" type="email" required value="<?php echo e(old('email', $request->email)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\tpku-finance-baru\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>