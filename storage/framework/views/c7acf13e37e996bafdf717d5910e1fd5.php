    ...
    <form class="mt-8 space-y-6" method="POST" action="<?php echo e(route('login')); ?>">
      ...
      <div>
        ...
        <input id="email" name="email" type="email" autocomplete="email" required
          ...
          placeholder="you@example.com" value="<?php echo e(old('email')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="text-sm">
          <a href="<?php echo e(route('password.request')); ?>" class="font-medium text-green-600 hover:text-green-500">Lupa Password?</a>
        </div>
      </div>
    ...
    <p class="mt-4 text-center text-sm text-gray-600">
      Belum punya akun?
      <a href="<?php echo e(route('register')); ?>" class="font-medium text-green-600 hover:text-green-500">Daftar sekarang</a>
    </p>
  </div>
</div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\tpku-finance-baru\resources\views/auth/login.blade.php ENDPATH**/ ?>